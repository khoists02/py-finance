...
def draw_histogram():
    ...
    # more_than_three = lazr.loc[lazr['Adj Close'] > 3].count()[0]  # NOTE: couting close value more than 3.0
    # mt_five_and_lesst_seven = lazr.loc[(lazr['Adj Close'] > 5) & (lazr['Adj Close'] < 7)].count()[0]  # NOTE: Multiple condition in loc function.
